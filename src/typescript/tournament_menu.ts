 ...
 */
function get_next_player_type(event: Event): void {
	const	clickedButton = event.target as HTMLButtonElement;
	const	buttonDiv = clickedButton.parentNode as HTMLDivElement;
	const	childP = buttonDiv.querySelector("p") as HTMLParagraphElement;
 ...
 * @paran event -- event object
 */
function get_prev_player_type(event: Event): void {
	const	clickedButton = event.target as HTMLButtonElement;
	const	buttonDiv = clickedButton.parentNode as HTMLDivElement;
	const	childP = buttonDiv.querySelector("p") as HTMLParagraphElement;
...
function update_player() {
	...
	if (!slider)
		return;
	const	slider_val = player_nbr_val[Number(slider.value)] as number;
...
function set_player_nbr() {
	var	slider = document.getElementById("player_nbr_slider") as HTMLInputElement;
	var	text_field = document.getElementById("player_nbr") as HTMLParagraphElement;
