 ...
 * Define drawing var
 */
const GOLDEN_NUMBER_T = 1.618033;
const PLAYER_WIDTH_RATIO_T = 0.009;
const PLAYER_WIDTH_HEIGHT_RATIO_T = 10;
var PLAYER_HEIGHT_T;
var PLAYER_WIDTH_T;
const PLAYER_COLOR_T = "#FFFFFF";
const PLAYER_SPEED_T = 5;
/* Score + Text */
const FONT_NAME_T = "sans-serif";
var FONT_SIZE;
const SCORE_POS_RATIO_T = 0.9;
const MSG_POS_RATIO_T = 0.7;
/* Ball_T */
let ball_color_T = "#FFFFFF";
const BALL_INIT_SPEED_T = 10;
//const BALL_COLOR_T: string = "#FFFFFF";
const BALL_MAX_SPEED_T = 12;
var BALL_RADIUS_T;
/* Terrain draw */
const TERRAIN_COLOR_T = "#FFFFFF";
var TERRAIN_LINE_FAT;
/* Game_t status variable */
const PLAYER_ONE_T = 1;
const PLAYER_TWO_T = 2;
var game_t;
var end_game;
var game_interval;
var round_winner;
 ...
 */
function draw_player_t(player_T) {
    if (!canvas)
        throw new Error("Canvas not found");
    if (!ctx)
        throw new Error("Context not found");
 ...
 */
function pressedKeyHandler_t(e) {
 ...
 */
function releasedKeyHandler_t(e) {
    if (e.key === "Up" || e.key === "ArrowUp")
        p2_upPressed = false;
    if (e.key === "Down" || e.key === "ArrowDown")
 ...
 */
function launch_game_t(p1_name, p2_name) {
    if (!canvas)
        throw new Error("Canvas not found");
    if (!p1_name || !p2_name)
...
const getUserName_t = () => __awaiter(void 0, void 0, void 0, function* () {
